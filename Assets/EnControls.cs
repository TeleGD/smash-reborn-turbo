...
//     version 1.4.3
//     from Assets/EnControls.inputactions
//
...
public partial class @EnControls : IInputActionCollection2, IDisposable
{
    ...
    {
        private @EnControls m_Wrapper;
        public GameplayActions(@EnControls wrapper) { m_Wrapper = wrapper; }
